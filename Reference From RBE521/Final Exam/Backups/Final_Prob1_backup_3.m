...
plot_cycle_joint_velocities = false; % Needs to be true for part 7
%% Problem 1
...
body_origin(:,1) = [0; 0; 0];
hip1(:,1) = [body_origin(1) + body_l/2; body_origin(2) + body_w/2; body_origin(3) + 0];
knee1(:,1) = hip1(:,1);
ankle1(:,1) = [knee1(1,1) + leg_lengths(2)*sind(-alpha(1,1))*cosd(beta(1,1)); knee1(2,1) + leg_lengths(2)*cosd(alpha(1,1))*cosd(beta(1,1)); knee1(3,1) + leg_lengths(2)*sind(beta(1,1))];
foot1(:,1) = [hip1(1,1) + x_pos(1,1); hip1(2,1) + 0.047; (hip1(3,1) + z_pos(1,1)) - body_height];
...
zlabel('z-axis')
O_h1 = quiver3(body_origin(1,1), body_origin(2,1), body_origin(3,1), hip1(1,1) - body_origin(1,1), hip1(2,1) - body_origin(2,1), hip1(3,1) - body_origin(3,1), 'off', '-k', 'ShowArrowHead', 'off');
h1_a1 = quiver3(hip1(1,1), hip1(2,1), hip1(3,1), ankle1(1,1) - hip1(1,1), ankle1(2,1) - hip1(2,1), ankle1(3,1) - hip1(3,1), 'off', '-k', 'ShowArrowHead', 'off');
a1_f1 = quiver3(ankle1(1,1), ankle1(2,1), ankle1(3,1), foot1(1,1) - ankle1(1,1), foot1(2,1) - ankle1(2,1), foot1(3,1) - ankle1(3,1), 'off', '-k', 'ShowArrowHead', 'off');
...
for n = 1:num_cycles
    ...
    for t = 2:size(t_cycle,2)

        % Recalculate Positions
        body_origin(1,t) = body_origin(1,t-1) ;%+ v*interval;
        hip1(:,t) = [body_origin(1,t) + body_l/2; body_origin(2,t) + body_w/2; body_origin(3,t) + 0];
        knee1(:,t) = hip1(:,t);
        ankle1(:,t) = [knee1(1,t) + leg_lengths(2)*sind(-alpha(1,t))*cosd(beta(1,t)); 
                       knee1(2,t) + leg_lengths(2)*cosd(alpha(1,t))*cosd(beta(1,t)); 
                       knee1(3,t) + leg_lengths(2)*sind(beta(1,t))];
        foot1(:,t) = [hip1(1,t) + x_pos(1,t); hip1(2,t) + 0.047; (hip1(3,t) + z_pos(1,t)) - body_height];

        % Replot
        hold on

        O_h1.XData = body_origin(1,t);
        O_h1.YData = body_origin(2,t);
        O_h1.ZData = body_origin(3,t);
        O_h1.UData = hip1(1,t) - body_origin(1,t);
        O_h1.VData = hip1(2,t) - body_origin(2,t);
        O_h1.WData = hip1(3,t) - body_origin(3,t);

        h1_a1.XData = hip1(1,t);
        h1_a1.YData = hip1(2,t);
        h1_a1.ZData = hip1(3,t);
        h1_a1.UData = ankle1(1,t) - hip1(1,t);
        h1_a1.VData = ankle1(2,t) - hip1(2,t);
        h1_a1.WData = ankle1(3,t) - hip1(3,t);

        a1_f1.XData = ankle1(1,t);
        a1_f1.YData = ankle1(2,t);
        a1_f1.ZData = ankle1(3,t);
        a1_f1.UData = foot1(1,t) - ankle1(1,t);
        a1_f1.VData = foot1(2,t) - ankle1(2,t);
        a1_f1.WData = foot1(3,t);% - ankle1(3,t);
